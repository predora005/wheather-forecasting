...
class Loader(AbsLoader):
    ...
    def _load_ground_weather(self, reload):
        ...
        if (reload == False) and (exist_csv == True):
            ...
            ground_dir = os.path.join(self.input_dir, 'ground_weather')
    ...
    def _load_highrise_weather(self, reload):
        ...
        # 保存ファイルの有無を確認する
        highrise_weather_csv = os.path.join(self.temp_dir, 'highrise_weather.csv')
        ...
        if (reload == False) and (exist_csv == True):
            ...
            highrise_dir = os.path.join(self.input_dir, 'highrise_weather')
