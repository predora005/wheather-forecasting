...
__WIND_DIRECTION_TO_ANGLE_MAP = {
    '西'    : 0.0,              '西南西': math.pi * 1 / 8,  '南西'  : math.pi * 2 / 8,
    '南南西': math.pi * 3 / 8,  '南'    : math.pi * 4 / 8,  '南南東': math.pi * 5 / 8,
    '南東'  : math.pi * 6 / 8,  '東南東': math.pi * 7 / 8,  '東'    : math.pi,
    '東北東': -math.pi * 7 / 8, '北東'  : -math.pi * 6 / 8, '北北東': -math.pi * 5 / 8,
    '北'    : -math.pi * 4 / 8, '北北西': -math.pi * 3 / 8, '北西'  : -math.pi * 2 / 8,
    '西北西': -math.pi * 1 / 8,
}
...
__WEATHER_REPLACE_MAP_COARSE = {
    ...
    101:2,                  # 降水                          -> 雨
    5:  2, 6:  2, 7:  2,    # 煙霧, 砂じん嵐, 地ふぶき      -> 雨
    15: 2, 0:  2            # 雷, 不明                      -> 雨
}

# 天気を変換するマップ(粗め,その他有り)
__WEATHER_REPLACE_MAP_COARSE2 = {
    1:  0, 2:  0,           # 快晴, 晴れ    -> 晴れ
    3:  1, 4:  1,           # 薄曇, 曇り    -> くもり
    8:  2, 9:  2, 10: 2,    # 霧, 霧雨, 雨                  -> 雨
    11: 2, 12: 2, 13: 2,    # みぞれ, 雪, あられ            -> 雨
